...
export default function Hero({title,subTitle,info}) {
    return (
        <div className='hero bg-bottom  bg-no-repeat lg:h-[calc(100vh-35px)] h-[calc(100vh-195px)]'>
            ...
            <h1 className="font-title mb-4 leading-10  w-100 font-extrabold lg:text-[40px] text-[24px]">
                {title}
            </h1>
            ...
            <div className="flex items-center gap-3 ">
                {
                    info.map((i,index) => {
                        return(
                            <div key={index} className="flex flex-col border-r border-r-[#b4b4b4] pr-4 nth-last-[1]:border-none">
